		...
		<div class="nl-content">
			<div class="nl-logo-area" id="custom_display_1">
				<a href="javascript:void(0)"> <img id="logo-img"
					...
					onerror-src=/static/img/passport/nl-logo.png"
					width="60">
				</a>
			</div>
			...
			<h2 class="nl-login-title lsrp-appname display-custom-hide" id="lsrp_appName"/>

			<div class="nl-phone-tip">
				<div id="message_LOGIN_PHONETIP">
					非大陆地区请在手机号码前面添加当地的国际代码前缀(如香港 +852 台湾 +886)
				</div>
